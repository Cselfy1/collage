...
/*
20
Ввести список студентів, які проживають у гуртожитку, враховуючи
прізвище, ініціали, рік народження, номер гуртожитку і кімнати.
Вивести за вказівкою користувача або повідомлення про студентів, які
проживають у заданому гуртожитку і народились у заданому році, або
прізвища студентів, які проживають у кімнатах із заданим номером у
двох заданих гуртожитках.
*/
